FILES_DIR = r'E:\Python33\code\manifest\manifestexcel'
PARA_FILE = r'E:\Python33\code\manifest\parameter.xls'
OUTPUT_ADDR = r'E:\Python33\code\manifest'
...
for filename in filenames:
	...
	polpod_result = pd.pivot_table(ubl_df,values=['箱量UNIT','箱量TEU','CY-CY运价'],index=['起运港/区域','卸港/区域','箱型'],aggfunc=np.sum)
	...
	polpod_result.to_excel(writer,'分流向运价统计',merge_cells=False,index=True)
