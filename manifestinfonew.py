...
for filename in filenames:
	...
	for svvd in svvdset:
		...
		zero_freight_teu = cdf[cdf['TTL AMT'] == 0]['箱量TEU'].sum() #计算未输入运费的提单箱量
		
		#输出结果
		f.write(svvd+','+str(int(round(total_teu,0)))+','+str(int(round(zero_freight_teu,0)))+'\n')
